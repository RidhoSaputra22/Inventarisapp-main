        ...
        <form class="bg-light w-100 m-5 p-4 " action="" style="border-radius: 10px;">
            ...
            <div class="row">
                ...
                <div class="input my-3 col">
                    ...
                    <input type="text" id="email" class="form-control border border-black">
                </div>
            </div>
            ...
            <div class="input my-3">
                <label class="form-label">DMS</label>
                <input type="text" id="dms" class="form-control border border-black">
            </div>
